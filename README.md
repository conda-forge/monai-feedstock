...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/monai-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14893&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/monai-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `monai` can be installed with:

```
conda install monai
```

It is possible to list all of the versions of `monai` available on your platform with:
